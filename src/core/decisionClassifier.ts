 ...
 * These map directly to the DECISION_PHILOSOPHY.md categories
 */
...
/**
 * Signals that inform classification
 */
...
): Result<DecisionClassification, Error> {
  try {
    ...
    return Ok(computeClassification(signals, proposal))
 ...
 */
function classifyPath(filepath: string): DecisionSignal[] {
  const signals: DecisionSignal[] = []
 ...
 */
function classifyCodeChange(code: string): DecisionSignal[] {
  const signals: DecisionSignal[] = []
 ...
 */
function buildPrematureReason(signals: DecisionSignal[]): string {
 ...
 */
function buildIrreversibleReason(signals: DecisionSignal[]): string {
 ...
 */
function buildReversibleReason(signals: DecisionSignal[]): string {
 ...
 */
export function getRequiredGates(classification: DecisionClassification): {
  gates: string[]

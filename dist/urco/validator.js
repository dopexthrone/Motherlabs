...
exports.validateEvidencePlan = validateEvidencePlan;
/**
...
function validateEvidencePlan(plan) {
    ...
    if (!p.artifacts || !Array.isArray(p.artifacts)) {
        ...
        for (let i = 0; i < p.artifacts.length; i++) {
            ...
            if (!a.kind || !validKinds.includes(a.kind)) {
                errors.push({
            ...
            if (!a.ref || typeof a.ref !== 'string' || a.ref.length === 0) {
                errors.push({

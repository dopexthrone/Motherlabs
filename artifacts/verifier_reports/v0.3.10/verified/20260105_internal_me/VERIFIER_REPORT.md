...
Expected SHA256: 20c2c61015dd15a82de2e2b6645f0d993241ced13c0c53ab27cbe25c5d5f66da
Actual SHA256:   20c2c61015dd15a82de2e2b6645f0d993241ced13c0c53ab27cbe25c5d5f66da
Match: YES
```
...
Expected: d96179fc848fa3f3aef76a5537a9f105be546b19
Match: YES
```
...
Expected (v0.3.10): 702 tests, 702 pass, 0 fail
...
Expected (v0.3.10): 10 passed, 0 failed, 0 changed, 0 new
...
```
Command: sha256sum -c artifacts/freeze/v0.3.10/file_sha256.txt 2>&1 | grep -c "OK"
Files OK: 182
Files FAILED: 0
Total: 182
```
...
- Model IO contract release (MODEL_IO_SPEC.md)
- New invariants: MI1-MI12 (model recording session verification)
- Consumer verifier + CLI tool (model-io-verify)
- Pack integration: optional model_io.json support
- 57 new tests (645 -> 702)
...
*Generated for: context-engine-kernel v0.3.10*

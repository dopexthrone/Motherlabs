...
**Transfer bundle ready:** `artifacts/transfer/v0.3.13/`

**External verification reports:**
| Date | Verifier | Release | Result | Kind | OS | Node | npm | Path |
|------|----------|---------|--------|------|-----|------|-----|------|
| 20260106 | internal_me | v0.3.13 | PASS | internal | Ubuntu 24.04.3 LTS | v24.11.1 | 11.6.2 | v0.3.13/verified/20260106_internal_me/ |
...
| Tag date | 2026-01-05 |
| Reference run | `v0.3.12/` |
| Reference Tag | `v0.3.12-reference-20260105` |
| Independent verifiers | 0 |
| Internal verifiers | 1 |
| Verified | NO (pending external verification) |

**Transfer bundle ready:** `artifacts/transfer/v0.3.12/`

**External verification reports:**
| Date | Verifier | Release | Result | Kind | OS | Node | npm | Path |
|------|----------|---------|--------|------|-----|------|-----|------|
| 20260105 | internal_me | v0.3.12 | PASS | internal | Ubuntu 24.04.3 LTS | v24.11.1 | 11.6.2 | v0.3.12/verified/20260105_internal_me/ |
...
| Item | Value |
|------|-------|
| Commit | `ea2082cc3a0830acfcf764ff42b3e1c7c8bea461` |
| Tag date | 2026-01-05 |
| Reference run | `v0.3.11/` |
| Reference Tag | `v0.3.11-reference-20260105` |
| Independent verifiers | 0 |
| Internal verifiers | 1 |
| Verified | NO (pending external verification) |

**Transfer bundle ready:** `artifacts/transfer/v0.3.11/`

**External verification reports:**
| Date | Verifier | Release | Result | Kind | OS | Node | npm | Path |
|------|----------|---------|--------|------|-----|------|-----|------|
| 20260105 | internal_me | v0.3.11 | PASS | internal | Ubuntu 24.04.3 LTS | v24.11.1 | 11.6.2 | v0.3.11/verified/20260105_internal_me/ |
...
| Item | Value |
|------|-------|
| Commit | `d96179fc848fa3f3aef76a5537a9f105be546b19` |
| Tag date | 2026-01-05 |
| Reference run | `v0.3.10/` |
| Reference Tag | `v0.3.10-reference-20260105` |
| Independent verifiers | 0 |
| Internal verifiers | 1 |
| Verified | NO (pending external verification) |

**Transfer bundle ready:** `artifacts/transfer/v0.3.10/`

**External verification reports:**
| Date | Verifier | Release | Result | Kind | OS | Node | npm | Path |
|------|----------|---------|--------|------|-----|------|-----|------|
| 20260105 | internal_me | v0.3.10 | PASS | internal | Ubuntu 24.04.3 LTS | v24.11.1 | 11.6.2 | v0.3.10/verified/20260105_internal_me/ |
...
| Item | Value |
|------|-------|
| Commit | `a46d4cd66aca047a40ed30166aeebb1fe29e8101` |
| Tag date | 2026-01-05 |
| Reference run | `v0.3.9/` |
| Reference Tag | `v0.3.9-reference-20260105` |
| Independent verifiers | 0 |
| Internal verifiers | 0 |
| Verified | NO (pending external verification) |

**Transfer bundle ready:** `artifacts/transfer/v0.3.9/`
...
| Item | Value |
|------|-------|
| Commit | `71561854a8d70777eafdc6c7dab1e16712a637c1` |
| Tag date | 2026-01-05 |
| Reference run | `v0.3.8/` |
| Reference Tag | `v0.3.8-reference-20260105` |
| Independent verifiers | 0 |
| Internal verifiers | 0 |
| Verified | NO (pending external verification) |

**Transfer bundle ready:** `artifacts/transfer/v0.3.8/`
...
| Item | Value |
|------|-------|
| Commit | `aad23d01507293599d3f04fae15a0368dbbee0f4` |
| Tag date | 2026-01-05 |
| Reference run | `v0.3.7/` |
| Reference Tag | `v0.3.7-reference-20260105` |
| Independent verifiers | 0 |
| Internal verifiers | 0 |
| Verified | NO (pending external verification) |

**Transfer bundle ready:** `artifacts/transfer/v0.3.7/`

...
Expected SHA256: 4cd6df912dbe2c3d9aa194f791e762539bce6303f6ea733c36bc78e39c931b15
Actual SHA256:   4cd6df912dbe2c3d9aa194f791e762539bce6303f6ea733c36bc78e39c931b15
Match: YES
```
...
Expected: ee2286a5d097c7f857e71efa2c91d289aa934d89
Match: YES
```
...
Expected (v0.3.4): 428 tests, 428 pass, 0 fail
...
Expected (v0.3.4): 10 passed, 0 failed, 0 changed, 0 new
...
```
Command: sha256sum -c artifacts/freeze/v0.3.4/file_sha256.txt 2>&1 | grep -c "OK"
Files OK: 117
Files FAILED: 0
Total: 117
```
...
- Evidence and ledger contract release
- New specs: EVIDENCE_SPEC.md, LEDGER_SPEC.md
- New invariant tests: evidence_spec_invariants.test.ts, ledger_spec_invariants.test.ts
- EvidenceCore hashing excludes ephemeral fields
- Ledger invariants: LD1-LD4 (one entry per line, monotonic timestamps, unique run IDs, valid hashes)
- 65 new tests (363 -> 428)
...
*Generated for: context-engine-kernel v0.3.4*
